...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videos, autoPlay = true }) => {
  ...
  const landscapeStyles = isLandscape || isFullscreen ? {
    maxWidth: '100vw',
    width: '100vw',
    height: '100vh',
    margin: '0',
      ...
      <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/80 to-transparent flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className={`${loopEnabled ? 'text-purple-400' : 'text-white'} hover:bg-white/20`}
            title={loopEnabled ? "Looping enabled" : "Looping disabled"}
          >
            <Repeat size={20} />
          </Button>
